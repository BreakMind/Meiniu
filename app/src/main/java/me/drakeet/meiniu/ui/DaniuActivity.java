...
import me.drakeet.meiniu.util.DateUtils;
import me.drakeet.meiniu.LoveBus;
import me.drakeet.meiniu.R;
import me.drakeet.meiniu.ui.adapter.DaniuPagerAdapter;

public class DaniuActivity extends ToolbarActivity implements ViewPager.OnPageChangeListener {
    ...
    DaniuPagerAdapter mPagerAdapter;
    Date mGankDate;


    @Override protected int provideContentViewId() {
        return R.layout.activity_daniu;
    }
    ...
    private void initViewPager() {
        mPagerAdapter = new DaniuPagerAdapter(getSupportFragmentManager(), mGankDate);
    ...
    @Override public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_daniu, menu);
        return true;
    }
