...
import me.drakeet.meiniu.App;
import me.drakeet.meiniu.data.MeizhiData;
import me.drakeet.meiniu.model.Meizhi;
import me.drakeet.meiniu.ui.base.SwipeRefreshBaseActivity;
import me.drakeet.meiniu.R;
import me.drakeet.meiniu.data.休息视频Data;
import me.drakeet.meiniu.event.OnMeizhiTouchListener;
import me.drakeet.meiniu.ui.adapter.MeizhiListAdapter;
import me.drakeet.meiniu.util.AlarmManagerUtils;
...
public class MainActivity extends SwipeRefreshBaseActivity {
    ...
    private void startGankActivity(Date publishedAt) {
        Intent intent = new Intent(this, DaniuActivity.class);
        intent.putExtra(DaniuActivity.EXTRA_GANK_DATE, publishedAt);
